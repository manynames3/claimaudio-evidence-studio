  ...
  return (
    <LoginShell>
        <form onSubmit={handleSubmit} className="rounded-lg border bg-white p-5 shadow-panel">
          <div>
            <h2 className="text-lg font-semibold text-slate-950">Enter workspace</h2>
            <p className="mt-1 text-sm text-muted-foreground">
              Use the demo reviewer profile for this workspace.
            </p>
          </div>
      ...
      <section className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-[1fr_420px] lg:items-center">
        <div className="space-y-5">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            ...
            <ReadinessTile icon={LockKeyhole} title="Tenant scoped" text="Demo sessions are signed and org-scoped." />
          </div>
          <p className="rounded-md border border-amber-200 bg-amber-50 p-3 text-sm leading-6 text-amber-900">
            Use customer-approved demo files only. Production identity, retention, and legal hold controls should be finalized before broad confidential claim-file rollout.
          </p>
        </div>
